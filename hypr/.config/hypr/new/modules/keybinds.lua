...
hl.bind(mainMod .. " + M", hl.dsp.window.fullscreen({ scope = 1 }))
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen({ scope = 0 }))
...
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("cliphist list | rofi -dmenu -display-columns 2 -p '' -theme '$HOME/.config/rofi/config.rasi' | cliphist decode | wl-copy"))
